...
public class OnboardingTaskBuilder extends Builder implements SimpleBuildStep {
    ...
    public void perform(Run<?, ?> run, FilePath workspace, EnvVars env, Launcher launcher, TaskListener listener)
        ...
        OnboardingConfiguration onboardingSectionConfig = GlobalConfiguration.all()
                                                                                    .get(OnboardingConfiguration.class);
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public List<String> getCategories() {
            ...
            OnboardingConfiguration onboardingSectionConfig = GlobalConfiguration.all().get(OnboardingConfiguration.class);
            if (Objects.nonNull(onboardingSectionConfig)) {
